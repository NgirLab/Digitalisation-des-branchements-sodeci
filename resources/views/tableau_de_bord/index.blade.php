    ...
    <!-- Debut contenu principal -->
        ...
        <div class="kt-card">
            <div class="kt-card-header">
                ...
                <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo8/public-profile/works.html">
                    View All
                </a>
            </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="border border-orange-200 dark:border-orange-950 rounded-lg shrink-0">
                                <div class="flex items-center justify-center border-b border-orange-200 bg-orange-100 dark:border-orange-950 dark:bg-orange-950/30 rounded-t-lg">
        ...
        <div class="col-span-1 lg:col-span-2">
            <div class="flex flex-col gap-5 lg:gap-7.5">
                ...
                <div class="kt-card">
                        ...
                        <div class="w-9 start-0 top-9 absolute bottom-0 rtl:-translate-x-1/2 translate-x-1/2 border-s border-s-input">
                        </div>
                        ...
                        <div class="ps-2.5 mb-7 text-base grow">
                            ...
                            <a class="text-sm font-medium kt-link" href="html/demo8/public-profile/profiles/blogger.html">
                            Top 10 Tech Trends
                            </a>
                            </div>
                            <span class="text-xs text-secondary-foreground">
                        ...
                        <div class="ps-2.5 mb-7 text-base grow">
                            ...
                            <a class="text-sm kt-link" href="html/demo8/public-profile/profiles/blogger.html">
                            upcoming blog post
                            </a>
                            </div>
                            <span class="text-xs text-secondary-foreground">
                        ...
                        <div class="ps-2.5 mb-7 text-base grow">
                            ...
                            <img alt="image" class="dark:hidden max-h-[160px]" src="assets/media/illustrations/3.svg"/>
                            <img alt="image" class="light:hidden max-h-[160px]" src="assets/media/illustrations/3-dark.svg"/>
                            </div>
                            ...
                            <div class="flex items-center justify-center gap-1">
                                <a class="text-sm font-semibold link" href="html/demo8/public-profile/profiles/company.html">
                                Axio new release
                                </a>
                        ...
                        <div class="ps-2.5 mb-7 text-base grow">
                            ...
                            <a class="text-sm font-medium kt-ink" href="html/demo8/public-profile/profiles/feeds.html">
                            10,000 followers
                            </a>
                        ...
                        <div class="ps-2.5 text-base grow">
                            ...
                            <div class="text-sm text-foreground">
                            We recently
                            <a class="text-sm font-medium kt-link" href="html/demo8/public-profile/profiles/nft.html">
                            celebrated
                            </a>
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-content">
                        ...
                        <div class="flex items-center gap-2.5">
                        <span class="">
                            <i class="ki-filled ki-whatsapp text-lg text-muted-foreground">
                            </i>
                        </span>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-5 lg:gap-7.5">
                    <div class="kt-card">
                        ...
                        <div class="kt-card-footer justify-center">
                        <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo8/public-profile/network.html">
                        All Contributors
                        </a>
                        </div>
                    </div>
