<div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
        <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
         <div class="flex items-center gap-2">
          ...
          <div class="flex flex-col gap-1.5">
           ...
           <a class="text-xs text-secondary-foreground hover:text-primary font-medium leading-none" href="html/demo8/account/home/get-started.html">
            c.fisher@gmail.com
           </a>
          </div>
         </div>
        ...
        <ul class="kt-dropdown-menu-sub">
         ...
         <li>
          <a class="kt-dropdown-menu-link" href="html/demo8/account/home/user-profile.html">
         ...
         <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
          ...
          <div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
           <ul class="kt-dropdown-menu-sub">
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo8/account/home/get-started.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo8/account/security/overview.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo8/account/members/teams.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo8/account/integrations.html">
        ...
        <div class="px-2.5 pt-1.5 mb-2.5 flex flex-col gap-3.5">
         ...
         <a class="kt-btn kt-btn-outline justify-center w-full" href="html/demo8/authentication/classic/sign-in.html">
          Log out
         </a>
        </div>
       </div>