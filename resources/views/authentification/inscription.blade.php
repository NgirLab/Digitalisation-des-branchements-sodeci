...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="fr">
 <head><base href="../../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo8/authentication/classic/sign-in/index.html" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo8/authentication/classic/sign-in/index.html" property="og:url"/>
    ...
    <form action="#" class="kt-card-content flex flex-col gap-5 p-10" id="sign_up_form" method="post">
     <div class="text-center mb-2.5">
      ...
      <div class="flex items-center justify-center">
       ...
       <a class="text-sm link" href="http://localhost:8000/signin">
        Connexion
       </a>
      </div>
     </div>
     <div class="grid grid-cols-2 gap-2.5">
      <a class="kt-btn kt-btn-outline justify-center" href="#">
       <img alt="" class="size-3.5 shrink-0" src="{{ URL::asset('assets/media/brand-logos/google.svg') }}"/>
       Avec Google
      </a>
      <a class="kt-btn kt-btn-outline justify-center" href="#">
       <img alt="" class="size-3.5 shrink-0 dark:hidden" src="{{ URL::asset('assets/media/brand-logos/apple-black.svg') }}"/>
       <img alt="" class="size-3.5 shrink-0 light:hidden" src="{{ URL::asset('assets/media/brand-logos/apple-white.svg') }}"/>
       Avec Apple
      </a>
     </div>
