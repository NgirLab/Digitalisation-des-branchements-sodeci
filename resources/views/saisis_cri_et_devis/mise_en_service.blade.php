          ...
          <!-- Début kanban vue 1 -->
           <div class="kt-card">
            ...
            <div class="kt-card-footer justify-center gap-5">
              <button class="kt-btn" data-kt-modal-toggle="#modal_formulaire_mise_en_service">
                  <i class="ki-filled ki-pencil "></i>
                 CRI Mise en service
              </button>
               @include('saisis_cri_et_devis.form_mise_en_service')
            </div>
           </div>
            <!-- Fin kanban vue 1 -->
           ...
           <div class="kt-card">
            ...
            <div class="kt-card-footer justify-center gap-5">
             <a class="kt-btn kt-btn-primarys">
