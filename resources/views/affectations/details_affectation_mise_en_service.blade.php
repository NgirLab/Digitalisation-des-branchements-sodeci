<div> 
  <div class="kt-modal" data-kt-modal="true" id="modal_affectation_mise_en_service">
    <div class="kt-modal-content max-w-[300px] top-[10%]">
      <div class="kt-modal-header">
        <h3 class="kt-modal-title">Détails de l'affectation pour la mise en service</h3>
        <button
          type="button"
          class="kt-modal-close"
          aria-label="Close modal"
          data-kt-modal-dismiss="#modal_affectation_mise_en_service">
      ...
      <div class="kt-modal-body ">
         <!-- Début bloc vue  -->
          <div class="kt-card w-[90%] lg:w-[60%] mx-auto">
            <div class="kt-card-content grid gap-5 py-7.5">
              ...
              <div class="flex items-center justify-between flex-wrap my-2.5 gap-2">
                ...
                Nom et Prénom de l'agent affecté:
                </span>
                <div class="flex flex-wrap w-[280px]">
                  <select
                    class="kt-select w-full"
                      ...
                      data-kt-select-placeholder="Rechercher un agent...">
                  </select>
                </div>
              </div>
              <div class="border-t border-input border-dashed mb-3.5">
      ...
      <div class="kt-modal-footer">
        ...
        <div class="flex gap-4">
          <button
            ...
            <button class="kt-btn" id="btn_valider_affectation_mise_en_service">
              Valider le choix
            </button>
        </div>
      </div>
