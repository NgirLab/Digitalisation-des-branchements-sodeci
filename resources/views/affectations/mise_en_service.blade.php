      ...
      <div class="kt-container-fixed flex items-center justify-between flex-wrap gap-3">
        ...
        <div class="flex items-center flex-wrap gap-1.5 lg:gap-2.5">
            <h1 class="text-lg text-foreground font-semibold">
                Affecter pour la mise en service
            </h1>
        </div>
        <div class="flex items-center flex-wrap gap-1.5 lg:gap-2.5">
            <!-- Barre de recherche -->
      ...
      <div id="teams_cards" class="" style="">
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5"> 
          ...
          <div class="kt-card-footer justify-center">
            <button class="kt-btn kt-btn-primary" data-kt-modal-toggle="#modal_affectation_mise_en_service">
              <i class="ki-filled ki-user-edit"></i>
              Affecter à un agent
            </button>
            <button class="kt-btn kt-btn-primary" data-kt-modal-toggle="#modal_affectation_mise_en_service" style="display:none;">
              <i class="ki-filled ki-user-edit"></i>
...
@endsection
@include('affectations.details_affectation_mise_en_service') 
<!-- Debut script  -->
<script>
  ...
  document.addEventListener('click', function (e) {
    if (e.target.id === 'btn_valider_affectation_mise_en_service') {
      // Find the first card's affectation button
      const firstCard = document.querySelector('#teams_cards .kt-card');
      const affectButton = firstCard.querySelector('button[data-kt-modal-toggle="#modal_affectation_mise_en_service"]:not([style*="display:none"])');
      const modifyButton = firstCard.querySelector('button[data-kt-modal-toggle="#modal_affectation_mise_en_service"][style*="display:none"]');
      if (affectButton) {
      ...
      const dismissBtn = document.querySelector('[data-kt-modal-dismiss="#modal_affectation_mise_en_service"]');
      if (dismissBtn) {
        dismissBtn.click();
      }
    }
